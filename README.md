...
- `--salary-min`：最低薪资，单位 K，默认 15
- `--salary-max`：最高薪资，单位 K，默认 29
- `--exclude-keywords`：排除包含关键词的职位，逗号分隔；默认排除“应届、博士、英语”，传空字符串可关闭
...
- 默认排除职位卡片中包含“应届”“博士”“英语”的职位，可通过 `--exclude-keywords` 自定义
